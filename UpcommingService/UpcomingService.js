...
const dt = new DataTable("#upcomingHistoryTable", {
	...
	language: {
		paginate: {
			first: "<img src='img/firstPage.png' alt='first' />",
			previous: "<img src='img/previous.png' alt='previous' />",
			next: '<img src="img/previous.png" alt="next" style="transform: rotate(180deg)" />',
			last: "<img src='img/firstPage.png' alt='first' style='transform: rotate(180deg)' />",
		},
